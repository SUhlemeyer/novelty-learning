...
labels = [
    ...
    Label(  'train'                , 31 ,       11 , 'vehicle'         , 7       , True         , False        , (  0, 80,100) ),
    Label(  'motorcycle'           , 32 ,       12 , 'vehicle'         , 7       , True         , False        , (  0,  0,230) ),
    Label(  'bicycle'              , 33 ,       13 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
